...
| 데이터/스키마 | `Partial` | 예산(거래/카테고리/반복 템플릿)·자산(기관/구성원/계좌/종목/보유/가격/스냅샷/거래) Prisma 모델, repository, zod 검증 구현. 개발용 `db push` 중심, `mock-data` fallback 잔존 | `docs/known-risks.md`, `docs/build-and-dependencies.md` |
